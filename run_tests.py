...
Focuses on Processor as the main class.
"""
...
def demonstrate_usage():
    """Demonstrate Processor usage with examples."""
    print("\n" + "=" * 60)
    print("Processor Usage Demonstration")
    print("=" * 60)
    ...
    with patch('chenking.embedding_client.requests.post') as mock_post:
        ...
        integration_doc = {
            "id": "integration_001",
            "content": "This document demonstrates the integration capabilities of the Processor. It combines document validation with embedding generation to provide comprehensive analysis.",
