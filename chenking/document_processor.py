...
class DocumentProcessor:
    """
    Main class that combines DocumentChecker and EmbeddingClient to process documents.
    ...
    def __init__(self, api_url: str, **kwargs):
        """
        Initialize DocumentProcessor with embedding API URL and optional checker config.
        
        Args:
            api_url: URL for the embedding API service
            **kwargs: Configuration parameters passed to DocumentChecker
        """
        self.api_url = api_url
        self.checker = DocumentChecker(**kwargs)
